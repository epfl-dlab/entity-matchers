...
def get_model(args, model):
    ...
    ref_ent1_test, ref_ent2_test, valid_ent1, valid_ent2 = None, None, None, None
    # if "15" in folder:
    #     read_func = ut.read_dbp15k_input
    # else:
    #     read_func = ut.read_input
    if "ent_ids_1" not in os.listdir(args.data_dir):
        ori_triples1, ori_triples2, seed_sup_ent1, seed_sup_ent2, ref_ent1, ref_ent2, ref_ent1_test, ref_ent2_test \
            , valid_ent1, valid_ent2, _, ent_n, rel_n = ut.read_new_datasets(args.data_dir, args.fold_folder)
    else:
        ori_triples1, ori_triples2, seed_sup_ent1, seed_sup_ent2, ref_ent1, ref_ent2, _, ent_n, rel_n = ut.read_input(
            args.data_dir)
    # triples1, triples2 = ut.add_sup_triples(ori_triples1, ori_triples2, seed_sup_ent1, seed_sup_ent2)

    my_model = model(args, ent_n, rel_n, seed_sup_ent1, seed_sup_ent2, ref_ent1, ref_ent2,
                     ref_ent1_test, ref_ent2_test, valid_ent1, valid_ent2,
                     ori_triples1.ent_list,
                     ori_triples2.ent_list,
                     out_folder, args.extra_entities_percentage_valid, args.gpu)
