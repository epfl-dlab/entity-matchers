...
def parse_triples(triples):
    """
    Returns three sets containing subjects, predicates and objects from the triples specified as input.
    Parameters
    ----------
    triples
...
class KG:
    ...
    def set_relations(self, relation_triples):
        ...
        # Relation triples saved as set and list (TODO: what is the difference between local and global here?)
        ...
        # Get lists of h, r and t from the triples
        ...
        # Generate two dicts (see functions for definitions)
    ...
    def generate_relation_triple_dict(self):
        # rt_dict[h]=set((r,t)) (All possible relations of h with the tails)
        # hr_dict[t]=set((h,r)) (All possible relations of t with the heads)
    ...
    def generate_attribute_triple_dict(self):
        self.av_dict = dict()
        # av_dict[h] = set(a,v) (All properties a h has with some literals v)
    ...
    def parse_relations(self):
        # entity_relations_dict[ent] = set(relations) (All the relations for which ent is a head)
    ...
    def parse_attributes(self):
        ...
        # entity_attributes_dict[ent] = set(attributes) (All the properties (attributes) the head has)
