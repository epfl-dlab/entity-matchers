...
def main(args):
    ...
    ent_emb = pickle.load(
        open(ENT_EMB_PATH.format(dataset_prefix, LOAD_BASIC_BERT_UNIT_MODEL_EPOCH_NUM), "rb"))
    ...
    # save
    pickle.dump(neighViewInterF, open(NEIGHBORVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix), "wb"))
    pickle.dump(desViewInterF, open(DESVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix), "wb"))
    print("save neighbor-view similarty feature in:", NEIGHBORVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix))
    print("save description/name-view similarity Feature in:", DESVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix))
