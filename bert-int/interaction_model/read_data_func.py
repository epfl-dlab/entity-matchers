...
def get_attribute_value_type(value,value_type):
    ...
    if value_type.endswith("<http://www.w3.org/2001/XMLSchema#integer>"):
        return "integer"
    elif value_type.endswith("<http://www.w3.org/2001/XMLSchema#nonNegativeInteger>"):
        return "integer"
    elif value_type.endswith("<http://www.w3.org/2001/XMLSchema#decimal>"):
        return "integer"
    elif value_type.endswith("xsd:integer"):
        return "integer"
    elif value_type.endswith("xsd:decimal"):
        return "integer"
    elif value_type.endswith("<http://www.w3.org/2001/XMLSchema#double>"):
        return "float"
    elif value_type.endswith("degrees"):
        return "float"
    elif value_type.endswith("km2"):
        return "float"
        ...
        return "date"
    elif value_type.endswith("<http://www.w3.org/2001/XMLSchema#gYear>"):
        return "date"
    elif value_type.endswith("<http://www.w3.org/2001/XMLSchema#dateTime>"):
        return "date"
    elif value_type.endswith("xsd:date"):
        return "date"
