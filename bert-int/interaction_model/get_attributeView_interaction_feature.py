...
def main(args):
    ...
    value_emb = pickle.load(open(ATTRIBUTEVALUE_EMB_PATH.format(dataset_prefix), "rb"))
    value_list = pickle.load(open(ATTRIBUTEVALUE_LIST_PATH.format(dataset_prefix), "rb"))
    ...
    # save
    pickle.dump(features, open(ATTRIBUTEVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix), "wb"))
    print("save attribute-view similarity Feature in: ", ATTRIBUTEVIEW_SIMILARITY_FEATURE_PATH.format(dataset_prefix))
