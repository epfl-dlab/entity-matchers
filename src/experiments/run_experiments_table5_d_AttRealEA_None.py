"""
This script will reproduce the results in table 5-d of the paper (AttRealEA_None).
Note that each dataset sub-table will be stored into a dataset-specific .csv file
into the directory ./output/output_table5_d_AttRealEA_None.
You can also find the detailed logs for each run and experiment into ./output/output_table5_d_AttRealEA_None/log_folds
and ./output/output_table5_d_AttRealEA_None/log_exp.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Reproduce results in Table 5-d (AttRealEA_None side)")
    ...
    output_base = "./output"
    output_dir = f"{output_base}/output_table5_d_AttRealEA_None"
        ...
        for method in methods:
            ...
            if method != "PARIS":
                ...
                command = f"{conda_command} python3 -u ../run_experiment.py \
                            --method {method} \
                            --root_dataset {args.root_dataset}/AttRealEA_None \
                            --dataset {dataset} \
