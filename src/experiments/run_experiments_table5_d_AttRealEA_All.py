"""
This script will reproduce the results in table 5-d of the paper (AttRealEA_All).
Note that each dataset sub-table will be stored into a dataset-specific .csv file
into the directory ./output/output_table5_d_AttRealEA_All.
You can also find the detailed logs for each run and experiment into ./output/output_table5_d_AttRealEA_All/log_folds
and ./output/output_table5_d_AttRealEA_All/log_exp.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Reproduce results in Table 5-d (AttRealEA_All side)")
    ...
    output_base = "./output"
    output_dir = f"{output_base}/output_table5_d_AttRealEA_All"
        ...
        for method in methods:
            ...
            if method != "PARIS":
                ...
                command = f"{conda_command} python3 -u ../run_experiment.py \
                            --method {method} \
                            --root_dataset {args.root_dataset}/AttRealEA_All \
                            --dataset {dataset} \
