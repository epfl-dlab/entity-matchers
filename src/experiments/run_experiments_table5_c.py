"""
This script will reproduce the results in table 5-c of the paper. Note that each dataset sub-table will be stored into
a dataset-specific .csv file into the directory ./output/output_table5_c. You can also find the detailed logs for each
run and experiment into ./output/output_table5_c/log_folds and ./output/output_table5_c/log_exp.
...
if __name__ == "__main__":
    ...
    methods = ["RDGCN", "BOOTEA", "TRANSEDGE", "BERT-INT-DESC", "BERT-INT-NO-DESC", "PARIS"]
    datasets = ["EN-FR-15K", "EN-DE-15K", "EN-JA-15K", "EN-JA-15K-PURE"]
    output_base = "./output"
    output_dir = f"{output_base}/output_table5_c"
    ...
    for dataset in datasets:
        ...
        root_dataset = f"{args.root_dataset}/XRealEA" if dataset != "EN-JA-15K-PURE" else f"{args.root_dataset}/XRealEA_Pure"
        for method in methods:
